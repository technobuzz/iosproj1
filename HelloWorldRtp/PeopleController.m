...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...[array objectAtIndex:indexPath.row];    
    
    Person *p = [array objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PersonDetailsController *detailViewController = [[[PersonDetailsController alloc] initWithNibName:nil bundle:nil]autorelease] ; 
